...
void app_main(void)
{
    ...
    /* Reproduction-only addition: remember one bonded peer and retry the
     * stock HFP AG outgoing SLC path after profile initialization. */
    ESP_ERROR_CHECK(reconnect_init());
