...
The 0.5.3-alpha release pairs this USB installer with the internal-test iPhone
companion setup flow. The [firmware release page](../docs/FIRMWARE_RELEASE.md)
distinguishes implementation from hardware validation.
...
setup requirements and limitations belong in `docs/FIRMWARE_RELEASE.md`, not in the
installer copy.
