...
class BuildScopeTest(unittest.TestCase):
    def setUp(self):
        ...
        for name in ("main/phone.cpp", "main/car.cpp", "main/main.cpp",
                     "sdkconfig.phone", "sdkconfig.car", "sdkconfig.defaults",
    ...
    def test_role_changes(self):
        for path, expected in (
            ("main/phone.cpp", ["phone"]), ("sdkconfig.phone", ["phone"]),
            ("main/car.cpp", ["car"]), ("sdkconfig.car", ["car"]),
            ("sdp_diagnostics/patch.py", ["car"]),
            ("main/main.cpp", ["phone", "car"]),
