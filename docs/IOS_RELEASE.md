# DashBridge iOS app 1.0 (build 12)
...
The app builds for the iOS simulator and its setup navigation tests pass. The
simulator cannot test ESP32 Bluetooth, Apple notification sharing, or a Tesla.
...
The `ios-v1.0-b12` tag creates the independent GitHub release record after a
