...
- **Espressif SDK:** [ESP-IDF v5.5.1](https://github.com/espressif/esp-idf/tree/v5.5.1), pinned commit `fcae32885b0296b32044cb99ecbdc50d98dddb83`.
...
- **BLE setup utility:** [Nordic nRF Connect for Mobile](https://www.nordicsemi.com/Products/Development-tools/nRF-Connect-for-mobile).
